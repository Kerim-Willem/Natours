...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2VyaW1mIiwiYSI6ImNrOW82c2gyMTA1dHYzbmw5cHFvYWxubTUifQ.rJ1Bglrzz-5IXU3e_oC1TA';
  var map = new mapboxgl.Map({
    // this will put a map on the element of map
    container: 'map',
    style: 'mapbox://styles/kerimf/ck9o6vi6315cy1ilewub2wz6t',
    scrollZoom: false // we can specify the center of the map, so where the map is focussed
  ...
  locations.forEach(function (loc) {
    // Create marker
    var el = document.createElement('div'); // So now we can use css for this marker. If you look at how it looks like, it's completely created by Jonas. He imports the image of the marker and then specifies it with css
...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); // afterbegin: Inside of body, but after the beginning

  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // Just to state the obvious. This is for setting the duration of the alert
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              // deleting so it's fixed for production http://127.0.0.1:3000
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                ...
                location.assign('/'); // setTimeout for 1500 miliseconds
              }, 1500);
            }
...
var stripe = Stripe('pk_test_pQpzvoW6Namtdz8JF1xNIokb00kxiwonG2');
...
var loginForm = document.querySelector('.form--login'); // The class .nav__el--logout looks weird because it's built in pug templates.
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); // for changing picture on form

  var form = new FormData();
  form.append('name', document.getElementById('name').value);
  form.append('email', document.getElementById('email').value);
  form.append('photo', document.getElementById('photo').files[0]);
  console.log(form); // 'data' is what is send through the axios request
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...'; // e. target is the element that got clicked. This will create/fire off the booking session
